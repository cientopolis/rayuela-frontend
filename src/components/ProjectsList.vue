...
<div>
    ...
    <div class="container">
      ...
      <div v-for="project in projects" :key="project.id">
        <div class="card" @click="showModal=true, actividad=false , getId=project.id, getName=project.name, getWeb=project.web, getImage=project.image, getDescription=project.description">
            <div>
